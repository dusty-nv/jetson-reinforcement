...
Reinforcement learners choose their own actions based on environmental state and rewards.  They represent an AI agent that can learn to behave optimally in it's environment given it's policy, or task - obtaining the reward.
